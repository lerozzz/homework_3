...
function f1() {
    let b1 = document.querySelector('.i-1');
    if (b1.value == 4) {
...
function f3() {
    let b3_1 = document.querySelector('.i-31');
    let b3_2 = document.querySelector('.i-32');
    if (b3_1.value > b3_2.value) {
        document.querySelector('.out-3').innerHTML = b3_1.value;
    }
    else {
        document.querySelector('.out-3').innerHTML = b3_2.value;
    }
}
...
function f4() {
    let b4 = document.querySelector('.i-4');
    if (b4.value <= 2005) {
...
function f5() {
    let b5 = document.querySelector('.i-5').value;
    let result;
    if (Math.sign(b5) > 0) {
        result = 1;
    }
...
function f6() {
    let b6 = document.querySelector('.i-6').value;
    let result;
    if (b6 % 2 == 0) {
        result = 'even';
    }
...
function f7() {
    let b7_1 = document.querySelector('.i-71').value;
    let b7_2 = document.querySelector('.i-72').value;
    document.querySelector('.out-7').innerHTML = b7_1 ** b7_2;
}
...
function f8() {
    let b8 = document.querySelector('.s-8').value;
    let result;
    switch (b8) {
        case "1":
            result = 'one';
...
function f9() {
    let b9 = document.querySelector('.i-9').value;
    let result;
    switch (true) {
        case (b9 > 0 && b9 < 33):
            result = 1;
...
function f10() {
    let b10 = document.querySelector('.s-100').value;
...
function f11() {
    let b11 = document.querySelector('.s-110').value;
